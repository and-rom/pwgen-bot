<?php
/*Messages*/
const START = "Привет! Я Telegram Бот, меня зовут FlimFlamBot. Я могу придумывать сложные и легко запоминающиеся пароли на основе забавных фраз. Или могу просто развеселить забавными фразами.
Отправь мне /help, и я подскажу как со мной общаться.
И еще. Иногда я задумываюсь, нужно просто подождать, я всегда отвечу.";

const HELP = "Если нужно придумать пароль, отправь мне /pw. А если нужно придумать забавную фразу, тогда - /ff.";

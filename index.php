...
$HELP .= "Подробнее о паролях: /help_pw";

$HELP_PW = "Команда /pw может иметь аргументы. Аргументы задаются в виде числа после пробела. Например, /pw_424" . PHP_EOL;
...
$HELP_PW .= "Например, если ввести только две цифры (/pw_31), то будут заданы параметры количества слов и количества цифр. ";

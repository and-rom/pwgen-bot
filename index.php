...
$HELP_PW = "Команда /pw может иметь аргументы. Аргументы задаются в виде числа после пробела. Например, _/pw 424_" . PHP_EOL;
...
$HELP_PW .= "Например, если ввести только две цифры (_/pw 31_), то будут заданы параметры количества слов и количества цифр. ";

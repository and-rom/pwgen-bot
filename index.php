...
/*Messages*/
$START = "Привет! Я Telegram бот, меня зовут FlimFlamBot. Я могу придумывать сложные и легко запоминающиеся пароли на основе забавных фраз.";
$START += "Или могу просто развеселить забавными фразами." . PHP_EOL;
...
$HELP_PW = "Комманда /pw может иметь аргументы. Аргументы задаются в виде числа после пробела. Например, /pw 424" . PHP_EOL;
$HELP_PW += "Цифр в числе может быть от 0 до 5" . PHP_EOL;
$HELP_PW += "Первая цифра - количество слов во фразе (значения от 3 до 5)." . PHP_EOL;
$HELP_PW += "Вторая цифра - количество цифр в начале фразы (значения от 0 до 4)." . PHP_EOL;
$HELP_PW += "Третья цифра - количество букв из каждого слова (значения от 2 до 4)." . PHP_EOL;
$HELP_PW += "Черверая цифра - использовать заглавные буквы в начале слов (1 - использовать, 0 - нет)." . PHP_EOL;
$HELP_PW += "Пятая цифра - использовать транслит (1 - использовать, 0 - нет)." . PHP_EOL;
